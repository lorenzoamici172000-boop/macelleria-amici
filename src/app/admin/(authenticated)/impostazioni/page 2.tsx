...
import { Palette, Building, Truck, Menu, Clock, MessageCircle } from 'lucide-react';

const SETTINGS_SECTIONS = [
  { href: '/admin/impostazioni/tema', icon: Palette, label: 'Tema Globale', description: 'Colori, font, pulsanti, stile hero' },
  { href: '/admin/impostazioni/attivita', icon: Building, label: 'Dati Attività', description: 'Nome, indirizzi, telefono, WhatsApp, social' },
  ...
  return (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
      {SETTINGS_SECTIONS.map(({ href, icon: Icon, label, description }) => (
        ...
        >
          <Icon size={24} className="text-gray-400 group-hover:text-gray-900 transition-colors mb-3" />
